...
VOICE_PRESETS = [
    ...
    # 粤语
    {"key": "Cantonese_ProfessionalHost(F)", "name": "粤语专业女主持", "engine": "minimax", "category": "dialect", "gender": "female", "locale": "zh-HK", "accent": "cantonese", "emotion": "natural", "speed": "1.0x", "sample_text": "粤语专业女主持。"},
    {"key": "Cantonese_ProfessionalHost(M)", "name": "粤语专业男主持", "engine": "minimax", "category": "dialect", "gender": "male",   "locale": "zh-HK", "accent": "cantonese", "emotion": "natural", "speed": "1.0x", "sample_text": "粤语专业男主持。"},
    ...
    {"key": "Cantonese_PlayfulMan",          "name": "粤语活泼男声",   "engine": "minimax", "category": "dialect", "gender": "male",   "locale": "zh-HK", "accent": "cantonese", "emotion": "natural", "speed": "1.0x", "sample_text": "粤语活泼男声。"},
    {"key": "Cantonese_CuteGirl",            "name": "粤语可爱女孩",   "engine": "minimax", "category": "dialect", "gender": "female", "locale": "zh-HK", "accent": "cantonese", "emotion": "natural", "speed": "1.0x", "sample_text": "粤语可爱女孩。"},
    {"key": "Cantonese_KindWoman",           "name": "粤语善良女声",   "engine": "minimax", "category": "dialect", "gender": "female", "locale": "zh-HK", "accent": "cantonese", "emotion": "natural", "speed": "1.0x", "sample_text": "粤语善良女声。"},
    # 普通话 MiniMax 主播
    {"key": "Chinese (Mandarin)_Reliable_Executive",   "name": "沉稳高管",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "沉稳高管男声,商业财经。"},
    {"key": "Chinese (Mandarin)_Unrestrained_Young_Man","name": "不羁青年",      "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "不羁青年,慵懒霸道。"},
    ...
    {"key": "Chinese (Mandarin)_Male_Announcer",       "name": "播报男声",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "新闻播报男声。"},
    {"key": "Chinese (Mandarin)_Gentleman",            "name": "温润男声",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "温润绅士男声。"},
    {"key": "Chinese (Mandarin)_Lyrical_Voice",        "name": "抒情男声",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "抒情有感染力男声。"},
    ...
    {"key": "Chinese (Mandarin)_Gentle_Youth",         "name": "温润青年",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "邻家大哥哥,温润青年。"},
    ...
    {"key": "Chinese (Mandarin)_Straightforward_Boy",  "name": "率真弟弟",       "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "邻家少年,率真自然。"},
    {"key": "Chinese (Mandarin)_Pure-hearted_Boy",     "name": "清澈邻家弟弟",   "engine": "minimax", "category": "preset", "gender": "male",   "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "清澈纯真邻家弟弟。"},
    {"key": "Chinese (Mandarin)_News_Anchor",          "name": "新闻女声",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "新闻播报女声。"},
    ...
    {"key": "Chinese (Mandarin)_Sweet_Lady",           "name": "甜美女声",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "甜美邻家亲切感。"},
    {"key": "Chinese (Mandarin)_Warm_Bestie",          "name": "温暖闺蜜",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "温暖闺蜜对话感。"},
    {"key": "Chinese (Mandarin)_Wise_Women",           "name": "阅历姐姐",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "阅历丰富姐姐音。"},
    {"key": "Chinese (Mandarin)_Mature_Woman",         "name": "傲娇御姐",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "傲娇成熟御姐。"},
    {"key": "Chinese (Mandarin)_Warm_Girl",            "name": "温暖少女",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "甜美细腻治愈感。"},
    {"key": "Chinese (Mandarin)_Crisp_Girl",           "name": "清脆少女",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "清脆甜美治愈亲切。"},
    {"key": "Chinese (Mandarin)_Soft_Girl",            "name": "柔和少女",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "柔和清雅少女。"},
    {"key": "Chinese (Mandarin)_Cute_Spirit",          "name": "憨憨萌兽",       "engine": "minimax", "category": "preset", "gender": "female", "locale": "zh-CN", "accent": "mandarin", "emotion": "natural", "speed": "1.0x", "sample_text": "软萌稚嫩天真烂漫。"},
    # 多语种 (MiniMax 自然度更好)
    ...
    {"key": "Japanese_IntellectualSenior", "name": "日语知性",            "engine": "minimax", "category": "language", "gender": "male",   "locale": "ja-JP", "accent": "japanese", "emotion": "natural", "speed": "1.0x", "sample_text": "MiniMax 日语知性男声。"},
    {"key": "Japanese_DecisivePrincess",   "name": "日语 Decisive Princess","engine": "minimax", "category": "language", "gender": "female", "locale": "ja-JP", "accent": "japanese", "emotion": "natural", "speed": "1.0x", "sample_text": "傲娇严厉日语女声。"},
    {"key": "Japanese_OptimisticYouth",    "name": "日语阳光青年",        "engine": "minimax", "category": "language", "gender": "male",   "locale": "ja-JP", "accent": "japanese", "emotion": "natural", "speed": "1.0x", "sample_text": "日语阳光青年男声。"},
