...
const FAQS = [
  {
    q: '不愿意出镜怎么办?',
    a: '用数字人替你出镜. 上传一段 10 秒左右的形象视频, AI 学会你的脸 + 口型, 之后所有口播 monoi 都能替你录制. 也可以只克隆声音, 用现成的数字人形象.',
  },
  {
    q: '没有视频素材怎么办?',
  ...
  {
    q: '克隆声音 / 数字人形象有什么不一样?',
    a: '克隆声音 = 复刻你的声音 (上传 5-15s 样本); 数字人形象 = AI 替你出镜口播 (上传 10 秒左右形象视频). Pro 1 个克隆声音 / 5 个数字人形象, Max 3 个 / 10 个, 旗舰 5 个 / 不限.',
  },
  {
    q: '自动发布功能什么时候能用?',
