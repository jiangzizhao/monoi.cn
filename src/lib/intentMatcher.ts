...
const INTENTS: IntentEntry[] = [
  ...
  { form: '__form_original__', label: '原创文案', score: 0.9,
    keywords: [
      '写文案', '写一篇文案', '写一个文案', '写个文案', '帮我写文案',
      '原创文案', '帮我想标题', '想个脚本', '写脚本', '写口播稿',
      '生成文案', '生成一篇文案', '生成一个文案',
    ] },
  { form: '__form_rewrite__', label: '仿写文案', score: 0.9,
    keywords: ['仿写', '改写文案', '改写一下', '参考改写', '模仿这篇', '帮我仿写'] },
  { form: '__form_paste__', label: '我有文案', score: 0.85,
    keywords: ['我有文案', '我自己写好了文案', '粘贴文案', '已有文案', '我有现成的文案'] },

  // 配音
  { form: '__voice_preset__', label: '预设音色配音', score: 0.9,
    keywords: ['预设音色', '选个音色', '用音色配音', '内置音色', '帮我配音', '给文案配音'] },
  { form: '__voice_clone__', label: '克隆声音', score: 0.95,
    keywords: ['克隆声音', '克隆我的声音', '复刻声音', '声音克隆'] },
  { form: '__voice_upload__', label: '上传录音剪辑', score: 0.85,
    keywords: ['上传录音', '我自己录的', '去气口', '去口误', '处理我的录音'] },

  // 口播视频 — 关键词大幅扩, 用户常用的各种说法都兜进来不走 AI
  { form: '__narration_video__', label: '口播剪辑', score: 0.9,
    keywords: [
      '口播剪辑', '剪口播', '剪我录的视频', '词级剪辑',
      '剪视频', '剪辑视频', '剪个视频', '剪一下视频', '剪一段视频',
      '剪辑口播', '剪个口播', '剪辑一段口播', '剪我的视频', '剪我的口播',
      '口播视频',  // "做/生成/剪辑 + ... + 口播视频" 都能兜住
    ] },
  ...
  { form: '__form_footage__', label: '智能匹配素材', score: 0.85,
    keywords: ['配画面', '配素材', '匹配素材', '找视频片段', '智能匹配', 'b-roll', '找素材', '搜素材'] },

  // 封面
  { form: '__form_cover__', label: '生成封面', score: 0.95,
    keywords: ['生成封面', '做封面', '做个封面', '搞个封面', '弄个封面', '封面生成', '出封面图', '弄封面', '封面图', '生成一个封面'] },

  // 抠图 — '去背景' 太宽容易跟"去背景音乐"撞, 改成"抠掉背景/去除背景"等更精确
  { form: '__form_cutout__', label: '人物抠图', score: 0.95,
    keywords: ['抠图', '抠人物', '抠出人物', '抠掉背景', '去除背景', '透明背景', '透明 png', '透明PNG', '抠张图', '抠个图', '抠一张'] },

  // 发布
  { form: '__form_publish__', label: '自动发布', score: 0.9,
    keywords: ['一键发布', '自动发布', '发抖音', '发小红书', '发布到抖音', '发布到小红书', '发到抖音', '发到小红书'] },
]
